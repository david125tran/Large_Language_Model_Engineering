...
**Day05** - Using BeautifulSoup to scrape URLs from my GitHub.  Then using OpenAi's 'gpt-4o-mini' API platform to find relevant links to create a resume showcasing my projects in markdown.  
